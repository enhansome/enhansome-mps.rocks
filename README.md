...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 322,080 | 🐛 20 | 🌐 Python | 📅 2026-09-20 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,479 | 🐛 9 | 🌐 Rust | 📅 2026-09-20.
...
* [MPS Extensions](https://github.com/JetBrains/MPS-extensions) ⭐ 88 | 🐛 130 | 🌐 JetBrains MPS | 📅 2026-09-21 - Various extensions to simplify language development.
...
* [mbeddr](https://github.com/mbeddr/mbeddr.core) ⭐ 232 | 🐛 85 | 🌐 JetBrains MPS | 📅 2026-09-21 - An extensible C implementation in MPS to support embedded software development.
...
* [iets3](https://github.com/iets3/iets3.opensource) ⭐ 53 | 🐛 128 | 🌐 JetBrains MPS | 📅 2026-09-21 - Base language for system modelling and specification including basics abstractions for  components, expression, variability, etc.
