...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 322,694 | 🐛 20 | 🌐 Python | 📅 2026-09-23 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,526 | 🐛 10 | 🌐 Rust | 📅 2026-09-24.
...
* [MPS Extensions](https://github.com/JetBrains/MPS-extensions) ⭐ 87 | 🐛 130 | 🌐 JetBrains MPS | 📅 2026-09-23 - Various extensions to simplify language development.
...
* [mbeddr](https://github.com/mbeddr/mbeddr.core) ⭐ 232 | 🐛 85 | 🌐 JetBrains MPS | 📅 2026-09-23 - An extensible C implementation in MPS to support embedded software development.
...
* [iets3](https://github.com/iets3/iets3.opensource) ⭐ 53 | 🐛 127 | 🌐 JetBrains MPS | 📅 2026-09-24 - Base language for system modelling and specification including basics abstractions for  components, expression, variability, etc.
