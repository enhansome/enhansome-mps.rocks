...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 323,166 | 🐛 21 | 🌐 Python | 📅 2026-09-25 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,563 | 🐛 12 | 🌐 Rust | 📅 2026-09-25.
...
* [MPS Extensions](https://github.com/JetBrains/MPS-extensions) ⭐ 87 | 🐛 128 | 🌐 JetBrains MPS | 📅 2026-09-26 - Various extensions to simplify language development.
...
* [MPS gradle plugin](https://github.com/mbeddr/mps-gradle-plugin) ⭐ 16 | 🐛 26 | 🌐 Kotlin | 📅 2026-09-15 - A Gradle plugin to build & test langauges and to support various tasks related to custom RCP packaging.
...
* [MPS-QA](https://github.com/mbeddr/mps-qa) ⭐ 9 | 🐛 10 | 🌐 JetBrains MPS | 📅 2026-09-18 - This repository contains quality assurance tooling for Jetbrains' MPS.
...
* [mbeddr](https://github.com/mbeddr/mbeddr.core) ⭐ 232 | 🐛 86 | 🌐 JetBrains MPS | 📅 2026-09-26 - An extensible C implementation in MPS to support embedded software development.
...
* [iets3](https://github.com/iets3/iets3.opensource) ⭐ 53 | 🐛 129 | 🌐 JetBrains MPS | 📅 2026-09-26 - Base language for system modelling and specification including basics abstractions for  components, expression, variability, etc.
...
* [DclareForMPS](https://github.com/ModelingValueGroup/DclareForMPS) ⭐ 21 | 🐛 27 | 🌐 JetBrains MPS | 📅 2026-09-11 - Support for the dclare engine in MPS.
