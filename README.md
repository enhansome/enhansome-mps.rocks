...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 314,586 | 🐛 16 | 🌐 Python | 📅 2026-08-16 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 58,877 | 🐛 7 | 🌐 Rust | 📅 2026-08-17.
...
* [MPS Extensions](https://github.com/JetBrains/MPS-extensions) ⭐ 88 | 🐛 122 | 🌐 JetBrains MPS | 📅 2026-08-18 - Various extensions to simplify language development.
...
* [mbeddr](https://github.com/mbeddr/mbeddr.core) ⭐ 233 | 🐛 83 | 🌐 JetBrains MPS | 📅 2026-08-18 - An extensible C implementation in MPS to support embedded software development.
...
* [iets3](https://github.com/iets3/iets3.opensource) ⭐ 53 | 🐛 122 | 🌐 JetBrains MPS | 📅 2026-08-17 - Base language for system modelling and specification including basics abstractions for  components, expression, variability, etc.
