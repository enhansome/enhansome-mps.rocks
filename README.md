...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 321,847 | 🐛 21 | 🌐 Python | 📅 2026-09-20 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,448 | 🐛 12 | 🌐 Rust | 📅 2026-09-20.
...
* [MPS Extensions](https://github.com/JetBrains/MPS-extensions) ⭐ 88 | 🐛 129 | 🌐 JetBrains MPS | 📅 2026-09-18 - Various extensions to simplify language development.
...
* [mbeddr](https://github.com/mbeddr/mbeddr.core) ⭐ 232 | 🐛 84 | 🌐 JetBrains MPS | 📅 2026-09-19 - An extensible C implementation in MPS to support embedded software development.
...
* [iets3](https://github.com/iets3/iets3.opensource) ⭐ 53 | 🐛 129 | 🌐 JetBrains MPS | 📅 2026-09-19 - Base language for system modelling and specification including basics abstractions for  components, expression, variability, etc.
