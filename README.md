...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 321,443 | 🐛 22 | 🌐 Python | 📅 2026-09-15 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,413 | 🐛 12 | 🌐 Rust | 📅 2026-09-18.
...
* [MPS-QA](https://github.com/mbeddr/mps-qa) ⭐ 9 | 🐛 12 | 🌐 JetBrains MPS | 📅 2026-09-18 - This repository contains quality assurance tooling for Jetbrains' MPS.
...
* [iets3](https://github.com/iets3/iets3.opensource) ⭐ 53 | 🐛 129 | 🌐 JetBrains MPS | 📅 2026-09-18 - Base language for system modelling and specification including basics abstractions for  components, expression, variability, etc.
