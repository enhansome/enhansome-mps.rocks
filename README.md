...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 322,259 | 🐛 20 | 🌐 Python | 📅 2026-09-22 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,498 | 🐛 9 | 🌐 Rust | 📅 2026-09-22.
...
* [MPS Extensions](https://github.com/JetBrains/MPS-extensions) ⭐ 88 | 🐛 130 | 🌐 JetBrains MPS | 📅 2026-09-22 - Various extensions to simplify language development.
...
* [mbeddr](https://github.com/mbeddr/mbeddr.core) ⭐ 232 | 🐛 85 | 🌐 JetBrains MPS | 📅 2026-09-22 - An extensible C implementation in MPS to support embedded software development.
...
* [iets3](https://github.com/iets3/iets3.opensource) ⭐ 53 | 🐛 126 | 🌐 JetBrains MPS | 📅 2026-09-22 - Base language for system modelling and specification including basics abstractions for  components, expression, variability, etc.
