...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 322,477 | 🐛 21 | 🌐 Python | 📅 2026-09-23 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,508 | 🐛 10 | 🌐 Rust | 📅 2026-09-22.
...
* [MPS Extensions](https://github.com/JetBrains/MPS-extensions) ⭐ 87 | 🐛 130 | 🌐 JetBrains MPS | 📅 2026-09-22 - Various extensions to simplify language development.
...
* [iets3](https://github.com/iets3/iets3.opensource) ⭐ 53 | 🐛 126 | 🌐 JetBrains MPS | 📅 2026-09-23 - Base language for system modelling and specification including basics abstractions for  components, expression, variability, etc.
