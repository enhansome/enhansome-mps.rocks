...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 321,241 | 🐛 21 | 🌐 Python | 📅 2026-09-15 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,385 | 🐛 11 | 🌐 Rust | 📅 2026-09-17.
...
* [MPS Extensions](https://github.com/JetBrains/MPS-extensions) ⭐ 88 | 🐛 127 | 🌐 JetBrains MPS | 📅 2026-09-16 - Various extensions to simplify language development.
...
* [MPS-QA](https://github.com/mbeddr/mps-qa) ⭐ 9 | 🐛 11 | 🌐 JetBrains MPS | 📅 2026-09-12 - This repository contains quality assurance tooling for Jetbrains' MPS.
...
* [mbeddr](https://github.com/mbeddr/mbeddr.core) ⭐ 232 | 🐛 82 | 🌐 JetBrains MPS | 📅 2026-09-13 - An extensible C implementation in MPS to support embedded software development.
...
* [iets3](https://github.com/iets3/iets3.opensource) ⭐ 53 | 🐛 130 | 🌐 JetBrains MPS | 📅 2026-09-17 - Base language for system modelling and specification including basics abstractions for  components, expression, variability, etc.
