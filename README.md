...
* [MPS Extensions](https://github.com/JetBrains/MPS-extensions) ⭐ 88 | 🐛 124 | 🌐 JetBrains MPS | 📅 2026-08-24 - Various extensions to simplify language development.
...
* [iets3](https://github.com/iets3/iets3.opensource) ⭐ 53 | 🐛 129 | 🌐 JetBrains MPS | 📅 2026-08-24 - Base language for system modelling and specification including basics abstractions for  components, expression, variability, etc.
