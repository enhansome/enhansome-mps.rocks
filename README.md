...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 320,578 | 🐛 18 | 🌐 Python | 📅 2026-09-13 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,341 | 🐛 11 | 🌐 Rust | 📅 2026-09-14.
...
* [iets3](https://github.com/iets3/iets3.opensource) ⭐ 53 | 🐛 129 | 🌐 JetBrains MPS | 📅 2026-09-14 - Base language for system modelling and specification including basics abstractions for  components, expression, variability, etc.
