...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 320,162 | 🐛 22 | 🌐 Python | 📅 2026-09-01 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,309 | 🐛 14 | 🌐 Rust | 📅 2026-09-10.
...
* [iets3](https://github.com/iets3/iets3.opensource) ⭐ 53 | 🐛 129 | 🌐 JetBrains MPS | 📅 2026-09-12 - Base language for system modelling and specification including basics abstractions for  components, expression, variability, etc.
