...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 320,353 | 🐛 23 | 🌐 Python | 📅 2026-09-01 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,329 | 🐛 12 | 🌐 Rust | 📅 2026-09-12.
...
* [MPS Extensions](https://github.com/JetBrains/MPS-extensions) ⭐ 88 | 🐛 127 | 🌐 JetBrains MPS | 📅 2026-09-13 - Various extensions to simplify language development.
