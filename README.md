...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 319,920 | 🐛 21 | 🌐 Python | 📅 2026-09-01 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,290 | 🐛 10 | 🌐 Rust | 📅 2026-09-10.
...
* [MPS Extensions](https://github.com/JetBrains/MPS-extensions) ⭐ 88 | 🐛 127 | 🌐 JetBrains MPS | 📅 2026-09-04 - Various extensions to simplify language development.
...
* [MPS-QA](https://github.com/mbeddr/mps-qa) ⭐ 9 | 🐛 11 | 🌐 JetBrains MPS | 📅 2026-09-11 - This repository contains quality assurance tooling for Jetbrains' MPS.
...
* [mbeddr](https://github.com/mbeddr/mbeddr.core) ⭐ 232 | 🐛 82 | 🌐 JetBrains MPS | 📅 2026-09-07 - An extensible C implementation in MPS to support embedded software development.
...
* [iets3](https://github.com/iets3/iets3.opensource) ⭐ 53 | 🐛 128 | 🌐 JetBrains MPS | 📅 2026-09-11 - Base language for system modelling and specification including basics abstractions for  components, expression, variability, etc.
