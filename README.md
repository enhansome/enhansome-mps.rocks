...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 318,657 | 🐛 17 | 🌐 Python | 📅 2026-09-01 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,213 | 🐛 10 | 🌐 Rust | 📅 2026-09-05.
...
* [mbeddr](https://github.com/mbeddr/mbeddr.core) ⭐ 233 | 🐛 82 | 🌐 JetBrains MPS | 📅 2026-09-05 - An extensible C implementation in MPS to support embedded software development.
