...
Inspired by [awesome-python](https://github.com/vinta/awesome-python/) ⭐ 314,215 | 🐛 27 | 🌐 Python | 📅 2026-08-16 and [awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 58,849 | 🐛 8 | 🌐 Rust | 📅 2026-08-15.
...
* [MPS Extensions](https://github.com/JetBrains/MPS-extensions) ⭐ 88 | 🐛 122 | 🌐 JetBrains MPS | 📅 2026-08-16 - Various extensions to simplify language development.
...
* [MPS gradle plugin](https://github.com/mbeddr/mps-gradle-plugin) ⭐ 16 | 🐛 27 | 🌐 Kotlin | 📅 2026-08-11 - A Gradle plugin to build & test langauges and to support various tasks related to custom RCP packaging.
...
* [MPS-QA](https://github.com/mbeddr/mps-qa) ⭐ 9 | 🐛 10 | 🌐 JetBrains MPS | 📅 2026-07-15 - This repository contains quality assurance tooling for Jetbrains' MPS.
...
* [mbeddr](https://github.com/mbeddr/mbeddr.core) ⭐ 233 | 🐛 86 | 🌐 JetBrains MPS | 📅 2026-08-13 - An extensible C implementation in MPS to support embedded software development.
...
* [iets3](https://github.com/iets3/iets3.opensource) ⭐ 53 | 🐛 122 | 🌐 JetBrains MPS | 📅 2026-08-12 - Base language for system modelling and specification including basics abstractions for  components, expression, variability, etc.
...
* [mbeddr.cpp](https://github.com/DSLFoundry/mbeddr.cpp) ⭐ 5 | 🐛 19 | 🌐 JetBrains MPS | 📅 2026-07-02 - C++ language implementation prototype for JetBrains MPS, built as an extension on mbeddr.core (C language).
